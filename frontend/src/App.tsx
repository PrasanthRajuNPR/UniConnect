...
const App: React.FC = () => {
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        {/* Login Route with setUser prop */}
        <Route path="/" element={<Login setUser={setUser} />} />

        {/* Admin Routes */}
        <Route
          path="/admin/*"
          element={<Layout role="admin" email={user?.email || ""} />}
        >
        ...
        >
          ...
          <Route
            path="attendance"
            element={<TeacherAttendance teacherId={user?._id || ""} />}
          />
          <Route
            path="assignments"
            element={<TeacherAssignMarks teacherId={user?._id || ""} />}
          />
        </Route>
        ...
        >
          ...
          <Route
            path="academics"
            element={<Academics studentId={user?._id || ""} />}
          />
          <Route
            path="attendance"
            element={<StudentAttendance studentId={user?._id || ""} />}
          />
          <Route
            path="assignments"
            element={<StudentAssignments studentId={user?._id || ""} />}
          />
          <Route
            path="fee"
            element={
